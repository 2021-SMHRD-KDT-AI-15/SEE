...
function callBackFunc_job(data) {
	document.getElementById("g_goal1").textContent = data[0].general_goal;
	document.getElementById("g_goal2").textContent = data[1].general_goal;
	...
	document.getElementById("y_goal1").textContent = data[0].young_goal;
	document.getElementById("y_goal2").textContent = data[1].young_goal;
	...
	document.getElementById("o_goal1").textContent = data[0].old_goal;
	document.getElementById("o_goal2").textContent = data[1].old_goal;
