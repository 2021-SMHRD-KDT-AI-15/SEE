	...
	<div id="full">
		...
		<div id="right">
			...
			%>
					...
					<tr>
						<td colspan="2"><canvas id="myChart1" width="90" height="50"></canvas>
						</td>
						<td colspan="2"><canvas id="myChart2" width="90" height="50"></canvas>
						</td>
						<td colspan="2"><canvas id="myChart3" width="90" height="50"></canvas>
						</td>
						<td colspan="2"><canvas id="myChart4" width="90" height="50"></canvas>
						</td>
