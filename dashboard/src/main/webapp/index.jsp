		...
		<div id="header">
			...
			<div id="full">
				...
				<div id="center">
					<div id="wheather">
						<div
							style="background-color: rgb(81, 83, 85); padding: 40px; color: #fff; width: 230px; height: 40px; border-radius: 20px;">
							...
							<div style="float: left; margin: -80px 0px 0px -20px;">
            ...
            <g id="hangjeongdong_광주광역시">
                <g ng-repeat="pop_rank in dong_pop_rank_list" ng-switch
                    ...
                    <g class="group" id="d-g" stroke-width="1">
                        ...
                        <path class="cls-1" stroke-width="1" stroke ="white"
