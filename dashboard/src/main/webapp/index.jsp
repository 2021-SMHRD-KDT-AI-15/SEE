				...
				<div id="center">
					...
					<div id="modal-box-dg">
						<div id="modal-contents">
							...
							<h2 class="title">
								<span class="ng-binding">동구</span> 통계 <span
									class="date ng-binding">(2023년 12월 기준)</span>
							</h2>
					...
					<div id="modal-box-sg">
						<div id="modal-contents">
							<a href="#none" class="btn-close">X</a>
							<h2 class="title">
								<span class="ng-binding">서구</span> 통계 <span
									class="date ng-binding">(2023년 12월 기준)</span>
							</h2>
					...
					<div id="modal-box-ng">
						<div id="modal-contents">
							<a href="#none" class="btn-close">X</a>
							<h2 class="title">
								<span class="ng-binding">남구</span> 통계 <span
									class="date ng-binding">(2023년 12월 기준)</span>
							</h2>
					...
					<div id="modal-box-bg">
						<div id="modal-contents">
							<a href="#none" class="btn-close">X</a>
							<h2 class="title">
								<span class="ng-binding">북구</span> 통계 <span
									class="date ng-binding">(2023년 12월 기준)</span>
							</h2>
					...
					<div id="modal-box-gg">
						<div id="modal-contents">
							<a href="#none" class="btn-close">X</a>
							<h2 class="title">
								<span class="ng-binding">광산구</span> 통계 <span
									class="date ng-binding">(2023년 12월 기준)</span>
							</h2>
